...
alias tunnel="grep -o '[a-z0-9-]*\.trycloudflare\.com' ~/tunnel-terminal.log 2>/dev/null | tail -1"
alias tunnelfiles="grep -o '[a-z0-9-]*\.trycloudflare\.com' ~/tunnel-files.log 2>/dev/null | tail -1"
